...
\item $1 \triangleq \lambda f.(\lambda x.(f  x))$
\item $2 \triangleq \lambda f.(\lambda x.(f (f  x))$
\item $3 \triangleq \lambda f.(\lambda x.(f (f (f  x))$
\end{itemize}
...
SUCC &\triangleq \lambda n.\lambda f.\lambda x.f(n fx)
\end{align*}
...
PLUS &\triangleq \lambda m.\lambda n.\lambda f	. \lambda x.m f(n fx)
\end{align*}
