...
Il ne faut pas confondre stabilité et attractivité car  stabilité est l'idée de ne pas diverger et attractif c'est l'idée de tendre vers un endroit. Et vice-versa.

\subsubsection{LTI}
Donc pour un système qui est du type $\frac{d}{dt}x(t) = Ax(t) + Bu(t)$ on va ramenée l'équilibre à $(0,0)$ car plus simple (\textit{changement de variable si besoin}).\par 
