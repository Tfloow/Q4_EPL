...
Un problème intrinsèquement complexes ont une complexité \textit{non polynomiale}.\par 
...
On sait que $P \subseteq NP$. Mais comment démontrer que $NP \subseteq P$ ou pas. On peut prendre un élément \textbf{E} qui "\textit{représentatif}" de NP et essayer de démontrer tel que:
\begin{itemize}
...
\begin{enumerate}
	...
	\item \textbf{SA: Soundness algorithmique:} \textcolor{red}{L'interpréteur de D est calculable}. Toute description $d \in D$ peut être effectivement exxécutée sur des données. Le formalisme $D$ est algorithmique. Cette caractéristique assure que $D$ décrit bien des procédés effectifs.
...
Une nouvelle classe est \textbf{BQP} ou Bounded-error Quantum Computing. Si il existe un algorithme \textit{quantique} polynomial qui donne la réponse au moins 2 fois sur 3.\par 
